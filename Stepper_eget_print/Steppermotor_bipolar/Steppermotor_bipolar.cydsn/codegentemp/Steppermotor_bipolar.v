...
module top ;
	...
	wire [0:0] tmpOE__B_inv_net;
	wire [0:0] tmpFB_0__B_inv_net;
	wire [0:0] tmpIO_0__B_inv_net;
	wire [0:0] tmpINTERRUPT_0__B_inv_net;
	electrical [0:0] tmpSIOVREF__B_inv_net;
	...
	cy_psoc3_pins_v1_10
		...
		B_inv
		 (.oe(tmpOE__B_inv_net),
		  .y({Net_146}),
		  .fb({tmpFB_0__B_inv_net[0:0]}),
		  .io({tmpIO_0__B_inv_net[0:0]}),
		  .siovref(tmpSIOVREF__B_inv_net),
		  .interrupt({tmpINTERRUPT_0__B_inv_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__B_inv_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__A_inv_net;
	wire [0:0] tmpFB_0__A_inv_net;
	wire [0:0] tmpIO_0__A_inv_net;
	wire [0:0] tmpINTERRUPT_0__A_inv_net;
	electrical [0:0] tmpSIOVREF__A_inv_net;
	...
	cy_psoc3_pins_v1_10
		...
		A_inv
		 (.oe(tmpOE__A_inv_net),
		  .y({Net_144}),
		  .fb({tmpFB_0__A_inv_net[0:0]}),
		  .io({tmpIO_0__A_inv_net[0:0]}),
		  .siovref(tmpSIOVREF__A_inv_net),
		  .interrupt({tmpINTERRUPT_0__A_inv_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__A_inv_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    CyControlReg_v1_80 Steps (
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Steps.Bit0Mode = 0;
    defparam Steps.Bit1Mode = 0;
    defparam Steps.Bit2Mode = 0;
    defparam Steps.Bit3Mode = 0;
    defparam Steps.Bit4Mode = 0;
    defparam Steps.Bit5Mode = 0;
    defparam Steps.Bit6Mode = 0;
    defparam Steps.Bit7Mode = 0;
    defparam Steps.BitValue = 0;
    defparam Steps.BusDisplay = 0;
    defparam Steps.ExtrReset = 0;
    defparam Steps.NumOutputs = 8;
