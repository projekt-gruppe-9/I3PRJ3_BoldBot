// ======================================================================
// Motorstyring.v generated from TopDesign.cysch
// 05/24/2019 at 15:55
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=0, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Motorpwm_Left, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Motorpwm_Left, CY_INSTANCE_SHORT_NAME=Motorpwm_Left, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Motorpwm_Left, )
module PWM_v3_30_1 (
    reset,
    clock,
    tc,
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1599996, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=133333, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_calR, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_calR, CY_INSTANCE_SHORT_NAME=ADC_calR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_calR, )
module ADC_SAR_v3_10_2 (
	...
	cy_clock_v1_0
		#(.id("23c8aa44-c156-4102-8ea8-601e13a422f0/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=1599996, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=0, ADC_Resolution=8, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=4, Sample_Rate=133333, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=ADC_calL, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_calL, CY_INSTANCE_SHORT_NAME=ADC_calL, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=ADC_calL, )
module ADC_SAR_v3_10_3 (
	...
	cy_clock_v1_0
		#(.id("db71b6d4-b574-4356-bdf7-ad0fa68d70ff/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625001562.503906"),
		  .is_direct(0),
...
module top ;
    ...
    PWM_v3_30_0 Motorpwm_right (
        ...
        .ph1(Net_795),
        .ph2(Net_796));
    defparam Motorpwm_right.Resolution = 8;


	cy_clock_v1_0
		#(.id("a04c4dac-190f-4173-a025-edfc51c58758"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000"),
		  .is_direct(0),
    ...
    PWM_v3_30_1 Motorpwm_Left (
        ...
        .ph1(Net_806),
        .ph2(Net_807));
    defparam Motorpwm_Left.Resolution = 8;

	wire [0:0] tmpOE__Motor_R_F_net;
	wire [0:0] tmpFB_0__Motor_R_F_net;
	wire [0:0] tmpIO_0__Motor_R_F_net;
	wire [0:0] tmpINTERRUPT_0__Motor_R_F_net;
	electrical [0:0] tmpSIOVREF__Motor_R_F_net;
	...
	cy_psoc3_pins_v1_10
		...
		Motor_R_F
		 (.oe(tmpOE__Motor_R_F_net),
		  .y({Net_341}),
		  .fb({tmpFB_0__Motor_R_F_net[0:0]}),
		  .io({tmpIO_0__Motor_R_F_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_R_F_net),
		  .interrupt({tmpINTERRUPT_0__Motor_R_F_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_R_F_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_L_F_net;
	wire [0:0] tmpFB_0__Motor_L_F_net;
	wire [0:0] tmpIO_0__Motor_L_F_net;
	wire [0:0] tmpINTERRUPT_0__Motor_L_F_net;
	electrical [0:0] tmpSIOVREF__Motor_L_F_net;

	cy_psoc3_pins_v1_10
		#(.id("8eeae011-98d4-40a4-ad62-6d6f0e0f7fd7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_L_F
		 (.oe(tmpOE__Motor_L_F_net),
		  .y({Net_345}),
		  .fb({tmpFB_0__Motor_L_F_net[0:0]}),
		  .io({tmpIO_0__Motor_L_F_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_L_F_net),
		  .interrupt({tmpINTERRUPT_0__Motor_L_F_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_L_F_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Enable_Right_net;
	wire [0:0] tmpFB_0__Enable_Right_net;
	wire [0:0] tmpIO_0__Enable_Right_net;
	wire [0:0] tmpINTERRUPT_0__Enable_Right_net;
	electrical [0:0] tmpSIOVREF__Enable_Right_net;

	cy_psoc3_pins_v1_10
		#(.id("b4831ac3-9515-414d-b154-6a298cea1d33"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Enable_Right
		 (.oe(tmpOE__Enable_Right_net),
		  .y({Net_378}),
		  .fb({tmpFB_0__Enable_Right_net[0:0]}),
		  .io({tmpIO_0__Enable_Right_net[0:0]}),
		  .siovref(tmpSIOVREF__Enable_Right_net),
		  .interrupt({tmpINTERRUPT_0__Enable_Right_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Enable_Right_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Enable_Left_net;
	wire [0:0] tmpFB_0__Enable_Left_net;
	wire [0:0] tmpIO_0__Enable_Left_net;
	wire [0:0] tmpINTERRUPT_0__Enable_Left_net;
	electrical [0:0] tmpSIOVREF__Enable_Left_net;

	cy_psoc3_pins_v1_10
		#(.id("daa46439-4741-46b9-a331-feb07513d7b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Enable_Left
		 (.oe(tmpOE__Enable_Left_net),
		  .y({Net_379}),
		  .fb({tmpFB_0__Enable_Left_net[0:0]}),
		  .io({tmpIO_0__Enable_Left_net[0:0]}),
		  .siovref(tmpSIOVREF__Enable_Left_net),
		  .interrupt({tmpINTERRUPT_0__Enable_Left_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Enable_Left_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : demux_1
        ...
        always @(Net_381 or Net_334)
        begin
            case (Net_334)
                1'b0:
                begin
                    tmp__demux_1_0_reg = Net_381;
                    tmp__demux_1_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_1_0_reg = 1'b0;
                    tmp__demux_1_1_reg = Net_381;
                end
            endcase
        end
        assign Net_337 = tmp__demux_1_0_reg;
        assign Net_342 = tmp__demux_1_1_reg;
    end
    // -- De Mux end --
    ...
    begin : demux_2
        ...
        always @(Net_381 or Net_377)
        begin
            case (Net_377)
                1'b0:
                begin
                    tmp__demux_2_0_reg = Net_381;
                    tmp__demux_2_1_reg = 1'b0;
                end
                1'b1:
                begin
                    tmp__demux_2_0_reg = 1'b0;
                    tmp__demux_2_1_reg = Net_381;
                end
            endcase
        end
        assign Net_347 = tmp__demux_2_0_reg;
        assign Net_350 = tmp__demux_2_1_reg;
    end
    // -- De Mux end --

	wire [0:0] tmpOE__Motor_L_R_net;
	wire [0:0] tmpFB_0__Motor_L_R_net;
	wire [0:0] tmpIO_0__Motor_L_R_net;
	wire [0:0] tmpINTERRUPT_0__Motor_L_R_net;
	electrical [0:0] tmpSIOVREF__Motor_L_R_net;

	cy_psoc3_pins_v1_10
		#(.id("db5cced2-98d9-4769-8a65-653496839c44"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_L_R
		 (.oe(tmpOE__Motor_L_R_net),
		  .y({Net_346}),
		  .fb({tmpFB_0__Motor_L_R_net[0:0]}),
		  .io({tmpIO_0__Motor_L_R_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_L_R_net),
		  .interrupt({tmpINTERRUPT_0__Motor_L_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_L_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Motor_R_R_net;
	wire [0:0] tmpFB_0__Motor_R_R_net;
	wire [0:0] tmpIO_0__Motor_R_R_net;
	wire [0:0] tmpINTERRUPT_0__Motor_R_R_net;
	electrical [0:0] tmpSIOVREF__Motor_R_R_net;

	cy_psoc3_pins_v1_10
		#(.id("0e31e792-1d27-453d-b4c2-24522953b98a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Motor_R_R
		 (.oe(tmpOE__Motor_R_R_net),
		  .y({Net_340}),
		  .fb({tmpFB_0__Motor_R_R_net[0:0]}),
		  .io({tmpIO_0__Motor_R_R_net[0:0]}),
		  .siovref(tmpSIOVREF__Motor_R_R_net),
		  .interrupt({tmpINTERRUPT_0__Motor_R_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Motor_R_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_341 = Net_337 | Net_348;


    assign Net_340 = Net_342 | Net_348;


    assign Net_345 = Net_347 | Net_348;


    assign Net_346 = Net_350 | Net_348;

    CyControlReg_v1_80 mode (
        .control_1(Net_334),
        .control_2(Net_377),
        .control_3(Net_381),
        .control_0(Net_348),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam mode.Bit0Mode = 0;
    defparam mode.Bit1Mode = 0;
    defparam mode.Bit2Mode = 0;
    defparam mode.Bit3Mode = 0;
    defparam mode.Bit4Mode = 0;
    defparam mode.Bit5Mode = 0;
    defparam mode.Bit6Mode = 0;
    defparam mode.Bit7Mode = 0;
    defparam mode.BitValue = 0;
    defparam mode.BusDisplay = 0;
    defparam mode.ExtrReset = 0;
    defparam mode.NumOutputs = 4;


    assign Net_378 = Net_382 | Net_348;


    assign Net_379 = Net_385 | Net_348;

    ADC_SAR_v3_10_2 ADC_calR (
        .vplus(Net_389),
        .vminus(Net_30),
        .soc(1'b0),
        .eoc(Net_32),
	...
	wire [0:0] tmpOE__cal_R_net;
	wire [0:0] tmpFB_0__cal_R_net;
	wire [0:0] tmpIO_0__cal_R_net;
	wire [0:0] tmpINTERRUPT_0__cal_R_net;
	electrical [0:0] tmpSIOVREF__cal_R_net;
	...
	cy_psoc3_pins_v1_10
		...
		cal_R
		 (.oe(tmpOE__cal_R_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cal_R_net[0:0]}),
		  .analog({Net_389}),
		  .io({tmpIO_0__cal_R_net[0:0]}),
		  .siovref(tmpSIOVREF__cal_R_net),
		  .interrupt({tmpINTERRUPT_0__cal_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cal_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__cal_L_net;
	wire [0:0] tmpFB_0__cal_L_net;
	wire [0:0] tmpIO_0__cal_L_net;
	wire [0:0] tmpINTERRUPT_0__cal_L_net;
	electrical [0:0] tmpSIOVREF__cal_L_net;

	cy_psoc3_pins_v1_10
		#(.id("bbd944d9-8b0b-4ca7-b2df-65e769c33daa"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		cal_L
		 (.oe(tmpOE__cal_L_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__cal_L_net[0:0]}),
		  .analog({Net_808}),
		  .io({tmpIO_0__cal_L_net[0:0]}),
		  .siovref(tmpSIOVREF__cal_L_net),
		  .interrupt({tmpINTERRUPT_0__cal_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__cal_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("e4d1e4b4-0e8b-4526-8f7a-789a79f15bdc"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("50000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8bdc20bd-f497-40b8-b1fe-c88f3b48a2d4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b0db6056-eda0-4152-a01f-94aeb7c41857"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__sonarOutput_net;
	wire [0:0] tmpFB_0__sonarOutput_net;
	wire [0:0] tmpINTERRUPT_0__sonarOutput_net;
	electrical [0:0] tmpSIOVREF__sonarOutput_net;

	cy_psoc3_pins_v1_10
		#(.id("e2b99437-5a92-40ed-8aa8-ca487bfc9f0a"),
		  .drive_mode(3'b100),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		sonarOutput
		 (.oe(tmpOE__sonarOutput_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__sonarOutput_net[0:0]}),
		  .io({Net_785}),
		  .siovref(tmpSIOVREF__sonarOutput_net),
		  .interrupt({tmpINTERRUPT_0__sonarOutput_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__sonarOutput_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


    assign Net_1035 = Net_343 | Net_1000;

    CyControlReg_v1_80 Stepper_control (
        .control_1(Net_119),
        .control_2(Net_935),
        .control_3(Net_936),
        .control_0(Net_343),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Stepper_control.Bit0Mode = 0;
    defparam Stepper_control.Bit1Mode = 0;
    defparam Stepper_control.Bit2Mode = 0;
    defparam Stepper_control.Bit3Mode = 0;
    defparam Stepper_control.Bit4Mode = 0;
    defparam Stepper_control.Bit5Mode = 0;
    defparam Stepper_control.Bit6Mode = 0;
    defparam Stepper_control.Bit7Mode = 0;
    defparam Stepper_control.BitValue = 0;
    defparam Stepper_control.BusDisplay = 0;
    defparam Stepper_control.ExtrReset = 0;
    defparam Stepper_control.NumOutputs = 2;


    assign Net_313 = ~(Net_263 & Net_281 & Net_283 & Net_284 & Net_285 & Net_286 & Net_287 & Net_288);
    ...
    assign Net_220 = ~Net_278;


    assign Net_217 = ~Net_276;


    assign Net_214 = ~Net_275;


    assign Net_211 = ~Net_272;


    assign Net_208 = ~Net_270;


    assign Net_205 = ~Net_268;


    assign Net_202 = ~Net_264;


    assign Net_199 = ~Net_265;


    assign Net_288 = Net_279 | Net_220;


    assign Net_287 = Net_277 | Net_217;


    assign Net_286 = Net_213 | Net_214;


    assign Net_285 = Net_273 | Net_211;


    assign Net_284 = Net_271 | Net_208;


    assign Net_283 = Net_269 | Net_205;


    assign Net_281 = Net_267 | Net_202;


    assign Net_263 = Net_198 | Net_199;

    CyControlReg_v1_80 Steps_1 (
        .control_1(Net_264),
        .control_2(Net_268),
        .control_3(Net_270),
        .control_0(Net_265),
        ...
        .clock(1'b0),
        .reset(1'b0));
    defparam Steps_1.Bit0Mode = 0;
    defparam Steps_1.Bit1Mode = 0;
    defparam Steps_1.Bit2Mode = 0;
    defparam Steps_1.Bit3Mode = 0;
    defparam Steps_1.Bit4Mode = 0;
    defparam Steps_1.Bit5Mode = 0;
    defparam Steps_1.Bit6Mode = 0;
    defparam Steps_1.Bit7Mode = 0;
    defparam Steps_1.BitValue = 0;
    defparam Steps_1.BusDisplay = 0;
    defparam Steps_1.ExtrReset = 0;
    defparam Steps_1.NumOutputs = 8;


    assign Net_279 = Net_186[7] & Net_278;


    assign Net_277 = Net_186[6] & Net_276;


    assign Net_213 = Net_186[5] & Net_275;


    assign Net_273 = Net_186[4] & Net_272;


    assign Net_271 = Net_186[3] & Net_270;


    assign Net_269 = Net_186[2] & Net_268;


    assign Net_267 = Net_186[1] & Net_264;


    assign Net_198 = Net_186[0] & Net_265;

	wire [0:0] tmpOE__stepper_B_inv_net;
	wire [0:0] tmpFB_0__stepper_B_inv_net;
	wire [0:0] tmpIO_0__stepper_B_inv_net;
	wire [0:0] tmpINTERRUPT_0__stepper_B_inv_net;
	electrical [0:0] tmpSIOVREF__stepper_B_inv_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("b7da1fda-97ab-4395-b606-99d9abbe81a7"),
		  ...
		  .input_buffer_sel(2'b00))
		stepper_B_inv
		 (.oe(tmpOE__stepper_B_inv_net),
		  .y({Net_146}),
		  .fb({tmpFB_0__stepper_B_inv_net[0:0]}),
		  .io({tmpIO_0__stepper_B_inv_net[0:0]}),
		  .siovref(tmpSIOVREF__stepper_B_inv_net),
		  .interrupt({tmpINTERRUPT_0__stepper_B_inv_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepper_B_inv_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__stepper_B_net;
	wire [0:0] tmpFB_0__stepper_B_net;
	wire [0:0] tmpIO_0__stepper_B_net;
	wire [0:0] tmpINTERRUPT_0__stepper_B_net;
	electrical [0:0] tmpSIOVREF__stepper_B_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("606d0192-5736-43d0-a32a-2fefabc39126"),
		  ...
		  .input_buffer_sel(2'b00))
		stepper_B
		 (.oe(tmpOE__stepper_B_net),
		  .y({Net_143}),
		  .fb({tmpFB_0__stepper_B_net[0:0]}),
		  .io({tmpIO_0__stepper_B_net[0:0]}),
		  .siovref(tmpSIOVREF__stepper_B_net),
		  .interrupt({tmpINTERRUPT_0__stepper_B_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepper_B_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__stepper_A_inv_net;
	wire [0:0] tmpFB_0__stepper_A_inv_net;
	wire [0:0] tmpIO_0__stepper_A_inv_net;
	wire [0:0] tmpINTERRUPT_0__stepper_A_inv_net;
	electrical [0:0] tmpSIOVREF__stepper_A_inv_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("bd1c7e50-222b-4693-b95c-27fd6362aa89"),
		  ...
		  .input_buffer_sel(2'b00))
		stepper_A_inv
		 (.oe(tmpOE__stepper_A_inv_net),
		  .y({Net_144}),
		  .fb({tmpFB_0__stepper_A_inv_net[0:0]}),
		  .io({tmpIO_0__stepper_A_inv_net[0:0]}),
		  .siovref(tmpSIOVREF__stepper_A_inv_net),
		  .interrupt({tmpINTERRUPT_0__stepper_A_inv_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepper_A_inv_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__stepper_A_net;
	wire [0:0] tmpFB_0__stepper_A_net;
	wire [0:0] tmpIO_0__stepper_A_net;
	wire [0:0] tmpINTERRUPT_0__stepper_A_net;
	electrical [0:0] tmpSIOVREF__stepper_A_net;

	cy_psoc3_pins_v1_10
		#(.id("736ea7ae-b748-4651-8c49-2697e984ec54"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		stepper_A
		 (.oe(tmpOE__stepper_A_net),
		  .y({Net_404[0]}),
		  .fb({tmpFB_0__stepper_A_net[0:0]}),
		  .io({tmpIO_0__stepper_A_net[0:0]}),
		  .siovref(tmpSIOVREF__stepper_A_net),
		  .interrupt({tmpINTERRUPT_0__stepper_A_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__stepper_A_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    begin : mux_2
        reg  tmp__mux_2_reg;
        always @(Net_131 or Net_132 or Net_119)
        begin
            case (Net_119)
                1'b0 :  tmp__mux_2_reg = Net_131;
                1'b1 :  tmp__mux_2_reg = Net_132;
            endcase
        end
        assign Net_1000 = tmp__mux_2_reg;
    end
    // -- Mux end --
    ...
    if (1)
    begin : mux_1
        reg [1:0] tmp__mux_1_reg;
        always @(Net_126 or Net_130 or Net_119)
        begin
            case (Net_119)
                1'b0 :  tmp__mux_1_reg = Net_126[1:0];
    ...
    // -- LUT Reverse_table start --
    if (1)
    begin : Reverse_table
        reg [2:0] tmp__Reverse_table_reg;
        wire [1:0] tmp__Reverse_table_ins;
        assign tmp__Reverse_table_ins = {Net_20[1],Net_20[0]};
        always @(tmp__Reverse_table_ins)
        begin
            case (tmp__Reverse_table_ins)
                2'b00 :  tmp__Reverse_table_reg = 3'b001;
                2'b01 :  tmp__Reverse_table_reg = 3'b000;
                2'b10 :  tmp__Reverse_table_reg = 3'b010;
                2'b11 :  tmp__Reverse_table_reg = 3'b111;
            endcase
        end
        assign {Net_132,Net_130[1],Net_130[0]} = tmp__Reverse_table_reg;
    end
    // -- LUT Reverse_table end --

    // -- LUT Forward_table start --
    if (1)
    begin : Forward_table
        reg [2:0] tmp__Forward_table_reg;
        wire [1:0] tmp__Forward_table_ins;
        assign tmp__Forward_table_ins = {Net_20[1],Net_20[0]};
        always @(tmp__Forward_table_ins)
        begin
            case (tmp__Forward_table_ins)
                2'b00 :  tmp__Forward_table_reg = 3'b011;
                2'b01 :  tmp__Forward_table_reg = 3'b010;
                2'b10 :  tmp__Forward_table_reg = 3'b000;
                2'b11 :  tmp__Forward_table_reg = 3'b101;
            endcase
        end
        assign {Net_131,Net_126[1],Net_126[0]} = tmp__Forward_table_reg;
    end
    // -- LUT Forward_table end --
    ...
    assign Net_944 = Net_343 & Net_943;


    assign Net_945 = ~Net_343;


    assign Net_349 = Net_945 & Net_1000;


    assign Net_338 = Net_944 | Net_349;
