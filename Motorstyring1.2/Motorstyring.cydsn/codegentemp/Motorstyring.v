...
module top ;
	...
	wire [0:0] tmpOE__Pin1_net;
	wire [0:0] tmpFB_0__Pin1_net;
	wire [0:0] tmpINTERRUPT_0__Pin1_net;
	electrical [0:0] tmpSIOVREF__Pin1_net;
	...
	cy_psoc3_pins_v1_10
		...
		Pin1
		 (.oe(tmpOE__Pin1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin1_net[0:0]}),
		  .io({Net_785}),
		  .siovref(tmpSIOVREF__Pin1_net),
		  .interrupt({tmpINTERRUPT_0__Pin1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
